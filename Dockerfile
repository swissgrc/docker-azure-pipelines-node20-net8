...
FROM ghcr.io/swissgrc/azure-pipelines-dotnet:8.0.203 AS base
...
LABEL org.opencontainers.image.documentation="https://github.com/swissgrc/docker-azure-pipelines-node20-net8"
